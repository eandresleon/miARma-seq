...
#
# This file was generated from the source file es_VE.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'es_VE' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Spanish Venezuela.
