...
#
# This file was generated from the source file mn_Mong_CN.xml
...
package DateTime::Locale::mn_Mong_CN;
...
use base 'DateTime::Locale::mn_Mong';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'mn_Mong_CN' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Mongolian Mongolian China.

=head1 DATA

This locale inherits from the L<DateTime::Locale::mn_Mong> locale.
