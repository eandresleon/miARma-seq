...
#
# This file was generated from the source file es_UY.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'es_UY' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Spanish Uruguay.
