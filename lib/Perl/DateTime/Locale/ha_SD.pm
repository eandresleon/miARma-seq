...
#
# This file was generated from the source file ha_SD.xml
...
use base 'DateTime::Locale::ha_Arab_SD';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ha_SD' );
  print $dt->month_name();
...
This locale inherits from the L<DateTime::Locale::ha_Arab_SD> locale.
