...
#
# This file was generated from the source file en_NA.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'en_NA' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for English Namibia.
