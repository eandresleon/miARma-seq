...
#
# This file was generated from the source file nds_DE.xml
...
package DateTime::Locale::nds_DE;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'nds_DE' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Low German Germany.

=head1 DATA

This locale inherits from the L<DateTime::Locale::nds> locale.
