...
# The source file version number was 1.128, generated on
# 2009/06/15 03:46:25.
#
...
{
    my $day_format_abbreviated = [ "lun", "mar", "mié", "jue", "vie", "sáb", "dom" ];
...
{
    my $day_format_wide = [ "lunes", "martes", "miércoles", "jueves", "viernes", "sábado", "domingo" ];
...
{
    my $era_wide = [ "antes\ de\ Cristo", "anno\ Dómini" ];
...
{
    my $month_format_abbreviated = [ "ene", "feb", "mar", "abr", "may", "jun", "jul", "ago", "sep", "oct", "nov", "dic" ];
...
{
    my $month_format_wide = [ "enero", "febrero", "marzo", "abril", "mayo", "junio", "julio", "agosto", "septiembre", "octubre", "noviembre", "diciembre" ];
...
{
    my $month_stand_alone_narrow = [ "E", "F", "M", "A", "M", "J", "J", "A", "S", "O", "N", "D" ];
...
{
    my $quarter_format_wide = [ "1er\ trimestre", "2º\ trimestre", "3er\ trimestre", "4º\ trimestre" ];
...
{
    my $_format_for_yMMMM = "MMMM\ \'de\'\ y";
...
{
    my $_format_for_yyQQQQ = "QQQQ\ \'de\'\ yy";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'es' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Spanish.
