...
#
# This file was generated from the source file sr_ME.xml
...
use base 'DateTime::Locale::sr_Latn_ME';
...
{
    my $glibc_date_1_format = "\%a\<U002c\>\ \%e\.\ \%b\ \%Y\.\ \ \%H\:\%M\:\%S\ \%Z\
";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'sr_ME' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Serbian Montenegro.

=head1 DATA

This locale inherits from the L<DateTime::Locale::sr_Latn_ME> locale.
...
=head3 Long
   ...
   2008-02-05T18:30:30 = 5.02.2008. 18.30.30 UTC
   1995-12-22T09:05:02 = 22.12.1995. 09.05.02 UTC
  -0010-09-15T04:44:23 = 15.09.-010. 04.44.23 UTC
