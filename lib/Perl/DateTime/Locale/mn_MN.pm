...
use base 'DateTime::Locale::mn_Cyrl_MN';
...
{
    my $glibc_date_1_format = "\%Z\ \%Y\ оны\ \%B\ \%e\,\ \%a\ \%H\:\%M\:\%S";
    sub glibc_date_1_format { return $glibc_date_1_format }
}

{
    my $glibc_datetime_format = "\%Y\ \%b\ \%d\,\ \%a\ \%T";
...
This locale inherits from the L<DateTime::Locale::mn_Cyrl_MN> locale.
