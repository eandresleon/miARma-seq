...
#
# This file was generated from the source file oc_FR.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'oc_FR' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Occitan France.

=head1 DATA

This locale inherits from the L<DateTime::Locale::oc> locale.
