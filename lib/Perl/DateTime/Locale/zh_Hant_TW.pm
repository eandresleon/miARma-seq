...
#
# This file was generated from the source file zh_Hant_TW.xml
...
package DateTime::Locale::zh_Hant_TW;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'zh_Hant_TW' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Chinese Traditional Han Taiwan.
