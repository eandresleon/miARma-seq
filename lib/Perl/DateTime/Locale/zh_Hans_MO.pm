...
#
# This file was generated from the source file zh_Hans_MO.xml
...
package DateTime::Locale::zh_Hans_MO;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'zh_Hans_MO' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Chinese Simplified Han Macau SAR China.
