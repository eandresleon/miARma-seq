...
#
# This file was generated from the source file ha_Arab_NG.xml
...
package DateTime::Locale::ha_Arab_NG;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ha_Arab_NG' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Hausa Arabic Nigeria.
