...
#
# This file was generated from the source file es_SV.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'es_SV' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Spanish El Salvador.
