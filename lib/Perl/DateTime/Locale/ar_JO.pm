...
{
    my $month_format_abbreviated = [ "كانون\ الثاني", "شباط", "آذار", "نيسان", "أيار", "حزيران", "تموز", "آب", "أيلول", "تشرين\ الأول", "تشرين\ الثاني", "كانون\ الأول" ];
...
{
    my $month_format_wide = [ "كانون\ الثاني", "شباط", "آذار", "نيسان", "أيار", "حزيران", "تموز", "آب", "أيلول", "تشرين\ الأول", "تشرين\ الثاني", "كانون\ الأول" ];
