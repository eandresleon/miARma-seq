...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'en_US_POSIX' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for English United States Computer.

=head1 DATA

This locale inherits from the L<DateTime::Locale::en_US> locale.
