...
#
# This file was generated from the source file ha_NE.xml
...
use base 'DateTime::Locale::ha_Latn_NE';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ha_NE' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Hausa Niger.

=head1 DATA

This locale inherits from the L<DateTime::Locale::ha_Latn_NE> locale.
