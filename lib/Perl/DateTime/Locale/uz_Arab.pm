...
{
    my $date_format_full = "y\ نچی\ ییل\ d\ نچی\ MMMM\ EEEE\ کونی";
    sub date_format_full { return $date_format_full }
}

{
    my $date_format_long = "d\ نچی\ MMMM\ y";
...
{
    my $day_format_abbreviated = [ "د\.", "س\.", "چ\.", "پ\.", "ج\.", "ش\.", "ی\." ];
...
{
    my $month_format_abbreviated = [ "جنو", "فبر", "مار", "اپر", "مـی", "جون", "جول", "اگس", "سپت", "اکت", "نوم", "دسم" ];
...
{
    my $_format_for_MMMMd = "d\ نچی\ MMMM";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'uz_Arab' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Uzbek Arabic.
