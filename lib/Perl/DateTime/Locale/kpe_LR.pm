...
#
# This file was generated from the source file kpe_LR.xml
...
package DateTime::Locale::kpe_LR;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'kpe_LR' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Kpelle Liberia.

=head1 DATA

This locale inherits from the L<DateTime::Locale::kpe> locale.
