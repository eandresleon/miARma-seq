...
use base 'DateTime::Locale::dv';

sub cldr_version { return "1\.7\.1" }

{
    my $first_day_of_week = "5";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'dv_MV' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Divehi Maldives.

=head1 DATA

This locale inherits from the L<DateTime::Locale::dv> locale.
