...
#
# This file was generated from the source file tg_Cyrl.xml
...
package DateTime::Locale::tg_Cyrl;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'tg_Cyrl' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Tajik Cyrillic.

=head1 DATA

This locale inherits from the L<DateTime::Locale::tg> locale.
