...
#
# This file was generated from the source file ku_Arab_IR.xml
...
package DateTime::Locale::ku_Arab_IR;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ku_Arab_IR' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Kurdish Arabic Iran.
