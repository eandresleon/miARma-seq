...
#
# This file was generated from the source file el_GR.xml
...
{
    my $glibc_date_1_format = "\%a\ \%d\ \%b\ \%Y\ \%r\ \%Z";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'el_GR' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Greek Greece.
