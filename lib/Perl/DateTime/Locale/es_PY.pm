...
#
# This file was generated from the source file es_PY.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'es_PY' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Spanish Paraguay.
