...
use base 'DateTime::Locale::az_Latn';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'az_Latn_AZ' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Azerbaijani Latin Azerbaijan.

=head1 DATA

This locale inherits from the L<DateTime::Locale::az_Latn> locale.
