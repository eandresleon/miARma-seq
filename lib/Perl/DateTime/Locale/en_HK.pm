...
{
    my $glibc_date_format = "\%A\,\ \%B\ \%d\,\ \%Y";
    sub glibc_date_format { return $glibc_date_format }
}

{
    my $glibc_datetime_format = "\%A\,\ \%B\ \%d\,\ \%Y\ \%p\%I\:\%M\:\%S\ \%Z";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'en_HK' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for English Hong Kong SAR China.
