...
#
# This file was generated from the source file fr_SN.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'fr_SN' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for French Senegal.
