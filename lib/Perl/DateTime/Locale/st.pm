...
{
    my $day_format_abbreviated = [ "Mma", "Bed", "Rar", "Ne", "Hla", "Moq", "Son" ];
...
{
    my $day_format_wide = [ "Mmantaha", "Labobedi", "Laboraru", "Labone", "Labohlane", "Moqebelo", "Sontaha" ];
...
{
    my $month_format_abbreviated = [ "Phe", "Kol", "Ube", "Mme", "Mot", "Jan", "Upu", "Pha", "Leo", "Mph", "Pun", "Tsh" ];
...
{
    my $month_format_wide = [ "Phesekgong", "Hlakola", "Hlakubele", "Mmese", "Motsheanong", "Phupjane", "Phupu", "Phata", "Leotshe", "Mphalane", "Pundungwane", "Tshitwe" ];
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'st' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Southern Sotho.
