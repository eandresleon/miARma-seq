...
#
# This file was generated from the source file zh_CN.xml
...
use base 'DateTime::Locale::zh_Hans_CN';
...
{
    my $glibc_date_1_format = "\%Y年\ \%m月\ \%d日\ \%A\ \%H\:\%M\:\%S\ \%Z";
    sub glibc_date_1_format { return $glibc_date_1_format }
}

{
    my $glibc_datetime_format = "\%Y年\%m月\%d日\ \%A\ \%H时\%M分\%S秒";
    sub glibc_datetime_format { return $glibc_datetime_format }
}

{
    my $glibc_time_format = "\%H时\%M分\%S秒";
    sub glibc_time_format { return $glibc_time_format }
}

{
    my $glibc_time_12_format = "\%p\ \%I时\%M分\%S秒";
...
This is the DateTime locale package for Chinese China.

=head1 DATA

This locale inherits from the L<DateTime::Locale::zh_Hans_CN> locale.
