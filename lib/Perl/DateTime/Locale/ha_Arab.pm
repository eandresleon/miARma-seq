...
{
    my $day_format_abbreviated = [ "لِت", "تَل", "لَر", "أَلْح", "جُم", "أَسَ", "لَح" ];
...
{
    my $day_format_wide = [ "لِتِنِنْ", "تَلَتَ", "لَرَبَ", "أَلْحَمِسْ", "جُمَعَ", "أَسَبَرْ", "لَحَدِ" ];
...
{
    my $era_abbreviated = [ "غَبَنِنْ\ مِلَدِ", "مِلَدِ" ];
...
{
    my $era_wide = [ "غَبَنِنْ\ مِلَدِ", "مِلَدِ" ];
...
{
    my $month_format_abbreviated = [ "جَن", "ڢَب", "مَر", "أَڢْر", "مَي", "يُون", "يُول", "أَغُ", "سَت", "أُكْت", "نُو", "دِس" ];
...
{
    my $month_format_wide = [ "جَنَيْرُ", "ڢَبْرَيْرُ", "مَرِسْ", "أَڢْرِلُ", "مَيُ", "يُونِ", "يُولِ", "أَغُسْتَ", "سَتُمْبَ", "أُكْتوُبَ", "نُوَمْبَ", "دِسَمْبَ" ];
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ha_Arab' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Hausa Arabic.

=head1 DATA

This locale inherits from the L<DateTime::Locale::ha> locale.
