...
#
# This file was generated from the source file sh_BA.xml
...
use base 'DateTime::Locale::sr_Latn_BA';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'sh_BA' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Serbo-Croatian Bosnia and Herzegovina.

=head1 DATA

This locale inherits from the L<DateTime::Locale::sr_Latn_BA> locale.
