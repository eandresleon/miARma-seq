...
#
# This file was generated from the source file nds.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'nds' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Low German.
