...
#
# This file was generated from the source file mn_Mong.xml
...
package DateTime::Locale::mn_Mong;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'mn_Mong' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Mongolian Mongolian.
