...
#
# This file was generated from the source file ug_Arab.xml
...
package DateTime::Locale::ug_Arab;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ug_Arab' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Uighur Arabic.

=head1 DATA

This locale inherits from the L<DateTime::Locale::ug> locale.
