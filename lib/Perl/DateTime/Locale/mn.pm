...
{
    my $day_format_abbreviated = [ "Да", "Мя", "Лх", "Пү", "Ба", "Бя", "Ня" ];
...
{
    my $day_format_wide = [ "даваа", "мягмар", "лхагва", "пүрэв", "баасан", "бямба", "ням" ];
...
{
    my $era_wide = [ "манай\ эриний\ өмнөх", "манай\ эриний" ];
...
{
    my $month_format_abbreviated = [ "хул", "үхэ", "бар", "туу", "луу", "мог", "мор", "хон", "бич", "тах", "нох", "гах" ];
...
{
    my $month_format_wide = [ "Хулгана", "Үхэр", "Бар", "Туулай", "Луу", "Могой", "Морь", "Хонь", "Бич", "Тахиа", "Нохой", "Гахай" ];
...
{
    my $quarter_format_abbreviated = [ "1\/4", "2\/4", "3\/4", "4\/4" ];
    sub quarter_format_abbreviated { return $quarter_format_abbreviated }
}
{
    my $quarter_format_wide = [ "дөрөвний\ нэг", "дөрөвний\ хоёр", "дөрөвний\ гурав", "дөрөвний\ дөрөв" ];
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'mn' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Mongolian.
