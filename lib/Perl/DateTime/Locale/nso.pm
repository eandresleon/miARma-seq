...
{
    my $day_format_abbreviated = [ "Mos", "Bed", "Rar", "Ne", "Hla", "Mok", "Son" ];
...
{
    my $day_format_wide = [ "Mosupalogo", "Labobedi", "Laboraro", "Labone", "Labohlano", "Mokibelo", "Sontaga" ];
...
{
    my $month_format_abbreviated = [ "Jan", "Feb", "Mat", "Apo", "Mei", "Jun", "Jul", "Ago", "Set", "Okt", "Nof", "Dis" ];
...
{
    my $month_format_wide = [ "Janaware", "Feberware", "Matšhe", "Aporele", "Mei", "June", "Julae", "Agostose", "Setemere", "Oktobore", "Nofemere", "Disemere" ];
