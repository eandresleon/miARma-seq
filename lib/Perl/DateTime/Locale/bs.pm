...
{
    my $month_format_wide = [ "Januar", "Februar", "Mart", "April", "Maj", "Juni", "Juli", "Avgust", "Septembar", "Oktobar", "Novembar", "Decembar" ];
...
{
    my $quarter_format_wide = [ "Prvi\ kvartal", "Drugi\ kvartal", "Treći\ kvartal", "Četvrti\ kvartal" ];
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'bs' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Bosnian.
