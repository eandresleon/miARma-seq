...
#
# This file was generated from the source file en_UM.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'en_UM' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for English U.S. Minor Outlying Islands.
