...
#
# This file was generated from the source file ug_Arab_CN.xml
...
package DateTime::Locale::ug_Arab_CN;
...
use base 'DateTime::Locale::ug_Arab';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ug_Arab_CN' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Uighur Arabic China.

=head1 DATA

This locale inherits from the L<DateTime::Locale::ug_Arab> locale.
