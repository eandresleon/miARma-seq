...
#
# This file was generated from the source file mn_Cyrl_MN.xml
...
package DateTime::Locale::mn_Cyrl_MN;
...
use base 'DateTime::Locale::mn_Cyrl';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'mn_Cyrl_MN' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Mongolian Cyrillic Mongolia.

=head1 DATA

This locale inherits from the L<DateTime::Locale::mn_Cyrl> locale.
