...
#
# This file was generated from the source file ro_MD.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ro_MD' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Romanian Moldova.
