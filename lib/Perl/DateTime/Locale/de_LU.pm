...
#
# This file was generated from the source file de_LU.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'de_LU' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for German Luxembourg.
