...
#
# This file was generated from the source file sr_BA.xml
...
use base 'DateTime::Locale::sr_Cyrl_BA';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'sr_BA' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Serbian Bosnia and Herzegovina.

=head1 DATA

This locale inherits from the L<DateTime::Locale::sr_Cyrl_BA> locale.
