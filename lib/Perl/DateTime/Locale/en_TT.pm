...
#
# This file was generated from the source file en_TT.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'en_TT' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for English Trinidad and Tobago.
