...
#
# This file was generated from the source file ku_Arab.xml
...
package DateTime::Locale::ku_Arab;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ku_Arab' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Kurdish Arabic.
