...
{
    my $am_pm_abbreviated = [ "àárọ̀", "ọ̀sán" ];
    sub am_pm_abbreviated { return $am_pm_abbreviated }
}
{
    my $day_format_abbreviated = [ "Ajé", "Ìsẹ́gun", "Ọjọ́rú", "Àṣẹ̀ṣẹ̀dáiyé", "Ẹtì", "Àbámẹ́ta", "Àìkú" ];
...
{
    my $day_format_wide = [ "Ọjọ́\ Ajé", "Ọjọ́\ Ìsẹ́gun", "Ọjọ́rú", "Ọjọ́\ Àṣẹ̀ṣẹ̀dáiyé", "Ọjọ́\ Ẹtì", "Ọjọ́\ Àbámẹ́ta", "Ọjọ́\ Àìkú" ];
...
{
    my $era_wide = [ "Saju\ Kristi", "Lehin\ Kristi" ];
...
{
    my $month_format_abbreviated = [ "Ṣẹ́rẹ́", "Èrèlè", "Ẹrẹ̀nà", "Ìgbé", "Ẹ̀bibi", "Òkúdu", "Agẹmọ", "Ògún", "Owewe", "Ọ̀wàrà", "Bélú", "Ọ̀pẹ̀" ];
...
{
    my $month_format_wide = [ "Oṣù\ Ṣẹ́rẹ́", "Oṣù\ Èrèlè", "Oṣù\ Ẹrẹ̀nà", "Oṣù\ Ìgbé", "Oṣù\ Ẹ̀bibi", "Oṣù\ Òkúdu", "Oṣù\ Agẹmọ", "Oṣù\ Ògún", "Oṣù\ Owewe", "Oṣù\ Ọ̀wàrà", "Oṣù\ Bélú", "Oṣù\ Ọ̀pẹ̀" ];
