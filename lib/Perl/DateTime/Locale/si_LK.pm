...
#
# This file was generated from the source file si_LK.xml
...
{
    my $glibc_date_1_format = "\%Y\ \%B\ \%e\ වැනි\ \%A\ \%H\:\%M\:\%S\ \%z";
    sub glibc_date_1_format { return $glibc_date_1_format }
}

{
    my $glibc_datetime_format = "\%Y\-\%m\-\%d\ \%H\:\%M\:\%S\ \%z";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'si_LK' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Sinhala Sri Lanka.

=head1 DATA

This locale inherits from the L<DateTime::Locale::si> locale.
