...
#
# This file was generated from the source file ug_CN.xml
...
use base 'DateTime::Locale::ug_Arab_CN';
...
{
    my $glibc_datetime_format = "\%Y\-\%m\-\%dT\%T\ \%Z";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ug_CN' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Uighur China.

=head1 DATA

This locale inherits from the L<DateTime::Locale::ug_Arab_CN> locale.
