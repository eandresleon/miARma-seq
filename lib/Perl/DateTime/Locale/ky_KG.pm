...
#
# This file was generated from the source file ky_KG.xml
...
{
    my $glibc_date_1_format = "\%a\,\ \%e\-\%b\ \%Y\ ж\,\ \%H\:\%M\:\%S\ \%Z";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ky_KG' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Kirghiz Kyrgyzstan.

=head1 DATA

This locale inherits from the L<DateTime::Locale::ky> locale.
