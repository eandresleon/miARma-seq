...
#
# This file was generated from the source file ku_SY.xml
...
use base 'DateTime::Locale::ku_Arab_SY';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ku_SY' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Kurdish Syria.

=head1 DATA

This locale inherits from the L<DateTime::Locale::ku_Arab_SY> locale.
