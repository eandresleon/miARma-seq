...
#
# This file was generated from the source file cop.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'cop' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Coptic.
