...
#
# This file was generated from the source file ar_EG.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ar_EG' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Arabic Egypt.
