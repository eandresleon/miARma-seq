...
#
# This file was generated from the source file ar_DZ.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ar_DZ' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Arabic Algeria.
