...
#
# This file was generated from the source file da_DK.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'da_DK' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Danish Denmark.

=head1 DATA

This locale inherits from the L<DateTime::Locale::da> locale.
