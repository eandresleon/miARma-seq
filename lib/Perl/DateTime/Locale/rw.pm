...
{
    my $day_format_abbreviated = [ "mbe\.", "kab\.", "gtu\.", "kan\.", "gnu\.", "gnd\.", "cyu\." ];
...
{
    my $day_format_wide = [ "Kuwa\ mbere", "Kuwa\ kabiri", "Kuwa\ gatatu", "Kuwa\ kane", "Kuwa\ gatanu", "Kuwa\ gatandatu", "Ku\ cyumweru" ];
...
{
    my $month_format_abbreviated = [ "mut\.", "gas\.", "wer\.", "mat\.", "gic\.", "kam\.", "nya\.", "kan\.", "nze\.", "ukw\.", "ugu\.", "uku\." ];
...
{
    my $month_format_wide = [ "Mutarama", "Gashyantare", "Werurwe", "Mata", "Gicuransi", "Kamena", "Nyakanga", "Kanama", "Nzeli", "Ukwakira", "Ugushyingo", "Ukuboza" ];
...
{
    my $quarter_format_abbreviated = [ "I1", "I2", "I3", "I4" ];
    sub quarter_format_abbreviated { return $quarter_format_abbreviated }
}
{
    my $quarter_format_wide = [ "igihembwe\ cya\ mbere", "igihembwe\ cya\ kabiri", "igihembwe\ cya\ gatatu", "igihembwe\ cya\ kane" ];
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'rw' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Kinyarwanda.
