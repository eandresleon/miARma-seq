...
{
    my $glibc_datetime_format = "\%A\ \%e\ \%B\ \%Y\ \ \%k\:\%M\:\%S";
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ar_SA' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Arabic Saudi Arabia.
