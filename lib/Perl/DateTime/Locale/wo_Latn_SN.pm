...
#
# This file was generated from the source file wo_Latn_SN.xml
...
package DateTime::Locale::wo_Latn_SN;
...
use base 'DateTime::Locale::wo_Latn';
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'wo_Latn_SN' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Wolof Latin Senegal.

=head1 DATA

This locale inherits from the L<DateTime::Locale::wo_Latn> locale.
