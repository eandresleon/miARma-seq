...
#
# This file was generated from the source file sr_Latn_RS.xml
...
package DateTime::Locale::sr_Latn_RS;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'sr_Latn_RS' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Serbian Latin Serbia.

=head1 DATA

This locale inherits from the L<DateTime::Locale::sr_Latn> locale.
