...
#
# This file was generated from the source file ee_GH.xml
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'ee_GH' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Ewe Ghana.
