...
use base 'DateTime::Locale::zh_Hant_TW';
...
{
    my $glibc_date_format = "西元\%Y年\%m月\%d日";
...
{
    my $glibc_datetime_format = "西元\%Y年\%m月\%d日\ \(\%A\)\ \%H時\%M分\%S秒";
...
This locale inherits from the L<DateTime::Locale::zh_Hant_TW> locale.
