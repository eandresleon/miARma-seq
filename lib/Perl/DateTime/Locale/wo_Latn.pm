...
#
# This file was generated from the source file wo_Latn.xml
...
package DateTime::Locale::wo_Latn;
...
=head1 SYNOPSIS
  ...
  my $dt = DateTime->now( locale => 'wo_Latn' );
  print $dt->month_name();

=head1 DESCRIPTION

This is the DateTime locale package for Wolof Latin.
