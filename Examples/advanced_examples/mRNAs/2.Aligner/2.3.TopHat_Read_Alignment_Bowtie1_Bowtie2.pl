...
BEGIN{
	...
	$tophat_aligner="Bowtie1-Bowtie2"; # Tophat uses bowtie2 by default, bowtie1 can be also specified. Especifing bowth, means to repeat the analysis one with each aligner (Allowed values: Bowtie1, Bowtie2 and Bowtie1-Bowtie2/Bowtie2-Bowtie1))
	$Seqtype="Paired";
}
