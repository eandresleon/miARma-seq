...
BEGIN{
	...
	$bowtie1index="../../../../Genomes/Indexes/bowtie1/human/bw1_homo_sapiens19"; #Indexed genome to align your reads in format .bt2 (Mandatory for analysis with bowtie2)
	$verbose="1"; #Option to show the execution data on the screen   
	...
	$tophat_aligner="Bowtie1" # Tophat uses bowtie2 by default, bowtie1 can be also specified. Especifing bowth, means to repeat the analysis one with each aligner (Allowed values: Bowtie1, Bowtie2 and Bowtie1-Bowtie2/Bowtie2-Bowtie1))
}
