...
BEGIN{
	...
	$DE_folder_miRNAs="../../miRNAs/6.Differential_expression/";# File from edgeR or Noiseq with differentually expressed miRNAs
	$DE_folder_genes="../4.DEAnalysis/";# File from edgeR or Noiseq with differentually expressed genes;
